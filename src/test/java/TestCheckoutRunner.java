...
import imi.function.amazon.getTelevisionPriceName;
import imi.pageObject.amazon.LeftSideBarPO;
import imi.pageObject.amazon.LoginPO;
import imi.pageObject.amazon.ProductListPO;
import imi.pageObject.amazon.ProductPO;
...
public class TestCheckoutRunner {
	...
	public void test1() {
		...
		getTelevisionPriceName priceNameList = PageFactory.initElements(driver, getTelevisionPriceName.class);
